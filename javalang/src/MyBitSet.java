...
/**
 * Created by licheng on 2/8/18.
 */
public class MyBitSet implements Cloneable, java.io.Serializable{
    /*
     ...
     * @since 1.7
     */
    public static MyBitSet valueOf(long[] longs) {
        int n;
        for (n = longs.length; n > 0 && longs[n - 1] == 0; n--)
            ;
        return new MyBitSet(Arrays.copyOf(longs, n));
    }
     ...
     * @since 1.7
     */
    public static MyBitSet valueOf(LongBuffer lb) {
        lb = lb.slice();
        int n;
     ...
     * @since 1.7
     */
    public static MyBitSet valueOf(byte[] bytes) {
        return MyBitSet.valueOf(ByteBuffer.wrap(bytes));
    }
     ...
     * @since 1.7
     */
    public static MyBitSet valueOf(ByteBuffer bb) {
    ...
    public MyBitSet get(int fromIndex, int toIndex) {
        ...
        MyBitSet result = new MyBitSet(toIndex - fromIndex);
     ...
     * @since  1.2
     */
    public void andNot(MyBitSet set) {
